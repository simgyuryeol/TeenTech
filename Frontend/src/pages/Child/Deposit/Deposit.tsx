...
const Deposit: React.FC = () => {
    ...
    return (
        ...
        <div className='border border-2 rounded-xl m-6 bg-white' style={{borderColor: '#ABD0CE'}}>
        ...
        <div>
            ...
            <div className='border rounded-xl shadow-md m-6 mb-0 flex justify-around bg-white' style={{borderColor: '#ABD0CE'}}>
                <div className='m-3'>
                    <p className='text-black'>{DepositName}</p>
                    <div className='flex justify-around'>
                    <p className={interestrate < 0 ? 'text-blue-500' : 'text-red-500'}>{interestrate}%</p>
                    <p className='text-white border rounded-md pr-1 pl-1' style={{backgroundColor: '#476C82'}}>{interest}</p>
                    </div>
                </div>
                <div className='m-3'>
            ...
            <div className='rounded-md shadow-md fixed bottom-10 left-[10%] w-[80%] bg-gray-200' style={{backgroundColor: '#EBF0F3'}}>
        <Link to="/DepositJoinDetail">
                <p className="text-lg m-4 font-bold" style={{color: '#3B5869'}}>예금 가입하기+</p>
        </Link>
            </div>
        </div>
    )
