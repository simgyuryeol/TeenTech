  ...
  return (
    <div className="pt-24">
      <section className="flex-row justify-start">
        ...
        <input placeholder="  인증코드" className="h-10 w-10/12 mb-3 rounded-md"></input>
      </section>
      <section>
        <div className="h-15	">
          <img src={teen9} style={{width: '100%', height: '100%'}}/>
        </div>
        <button className="bg-white rounded-2xl drop-shadow" onClick={()=>setIsModal(true)}>틴구변경</button>
        {isModal && (
          <Modal>
            <div className="flex flex-col items-center justify-center">
              ...
              <button className="mt-5 bg-white rounded-2xl drop-shadow"  onClick={()=>setIsModal(false)}>변경하기</button>
            </div>
          </Modal>
          )}
      </section>
