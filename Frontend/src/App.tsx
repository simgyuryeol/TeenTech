    ...
    <React.Fragment>
      <Router>
        <Routes>
          ...
          {/* 자식 */}
          <Route path="/Main" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Main key="main"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Mypage" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Mypage key="mypage"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/AccountBook" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <AccountBook key="accountbook"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/AccountBookDetail" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <AccountBookDetail key="accountbookdetail"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/AccountBookAdd" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <AccountBookAdd key="accountbook"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Alba" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Alba key="alba"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/AlbaCompleted" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <AlbaCompleted key="albacompleted"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Deposit" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Deposit key="deposit"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/DepositJoinDetail" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <DepositJoinDetail key="depositjoindetail"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/DepositJoinSuccess" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <DepositJoinSuccess key="depositjoinsuccess"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/DepositDetail/:id" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <DepositDetail key="depoisitdetail"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Loan" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>,  <Bot key="bot-componenet" />, <Loan key="loan" totalInProgressLoanCount={0} totalLoanBalance={0} inProgressLoanList={[]} loanLimitation={0}/>]}/>}/>
          <Route path="/LoanCompleted" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <LoanCompleted key="loancompleted"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Quiz" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Quiz key="quiz"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/QuizList/:eng" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <QuizList key="quizlist"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/QuizPlay/:eng" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <QuizPlay key="quizplay"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/QuizCommentary/:eng" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <QuizCommentary key="quizcommentary"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Stock" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Stock key="stock"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/StockMarket" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <StockMarket key="stockmarket"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/StockDetail/:companyName" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <StockDetail key="stockdetail"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/StockTradingList" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <StockTradingList key="stocktradinglist" />,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/Lotto" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <Lotto key="lotto"/>,  <Bot key="bot-componenet" />]}/>}/>
          <Route path="/LottoChange" element={<PrivateRoute state={state} authenticated={0} component={[<Header key="header-component"/>, <LottoChange key="lottochange"/>,  <Bot key="bot-componenet" />]}/>}/>
